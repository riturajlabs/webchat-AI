...
_SYSTEM_PROMPT_V1 = (
    ...
    "3. Provide a complete and thorough answer. Use as many sentences as needed "
    "to fully address the question - aim for 3-8 sentences depending on "
    "complexity. For simple questions, a short answer is fine. For complex "
    "questions, include all relevant details from the reference material. "
    "Always write in the same language as the question.\n"
