    ...
    <section id="features" className="scroll-mt-20 border-t border-border/60 bg-muted/30">
      <div className="mx-auto w-full max-w-6xl px-4 py-16 sm:px-6 lg:py-24">
        ...
        <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {FEATURES.map(({ icon: Icon, title, description, iconBg, iconFg }) => (
            <Card
              key={title}
            ...
            >
              <CardHeader>
                <span
                  className={`flex h-11 w-11 items-center justify-center rounded-xl transition-colors duration-200 ${iconBg} ${iconFg}`}
                >
