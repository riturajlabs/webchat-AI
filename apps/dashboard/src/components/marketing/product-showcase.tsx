...
const NAV_ITEMS = [
  ...
  { icon: Zap, label: 'Widget' },
];

export function ProductShowcase() {
  return (
    <section id="product" className="scroll-mt-20 border-t border-border/60 bg-muted/30">
      <div className="mx-auto w-full max-w-6xl px-4 py-16 sm:px-6 lg:py-24">
        <SectionHeading
          eyebrow="One platform"
          title="From website content to conversations — managed in one place."
          description="Crawl, index, configure and measure your AI assistant without juggling tools."
        />
          ...
          <div className="grid gap-6 lg:grid-cols-5">
            ...
            <div className="overflow-hidden rounded-2xl border border-border/60 bg-card shadow-xl lg:col-span-3">
              ...
              <div className="flex items-center gap-2 border-b border-border/60 bg-muted/50 px-4 py-2.5">
                ...
                <div className="ml-3 flex flex-1 items-center gap-2 rounded-md bg-background/80 px-3 py-1 text-xs text-muted-foreground">
              ...
              <div className="flex">
                ...
                <nav
                  ...
                  className="hidden w-40 shrink-0 flex-col gap-1 border-r border-border/60 p-3 sm:flex"
                >
            ...
            <div className="flex flex-col overflow-hidden rounded-2xl border border-border/60 bg-card shadow-xl lg:col-span-2">
              ...
              <div className="flex flex-1 flex-col gap-3 px-4 py-4">
                <div className="max-w-[85%] self-end rounded-2xl rounded-br-sm bg-blue-600 px-3.5 py-2.5 text-sm text-white">
                  How do I integrate the widget with React?
                </div>
                <div className="max-w-[85%] self-start rounded-2xl rounded-bl-sm bg-muted px-3.5 py-2.5 text-sm">
                  ...
                  <code className="font-mono text-[11px]">mount()</code> — see the Embed docs for
                  the full example.
                </div>
                <div className="max-w-[85%] self-end rounded-2xl rounded-br-sm bg-blue-600 px-3.5 py-2.5 text-sm text-white">
