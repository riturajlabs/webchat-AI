...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    // Documentation Portal Routes (15 pages)
    ...
    {
      url: `${SITE_URL}/docs/knowledge-sources`,
      lastModified: now,
      changeFrequency: 'monthly',
      priority: 0.8,
    },
    {
      url: `${SITE_URL}/docs/document-upload`,
      lastModified: now,
      changeFrequency: 'monthly',
      priority: 0.8,
    },
    {
      url: `${SITE_URL}/docs/rag-pipeline`,
      lastModified: now,
      changeFrequency: 'monthly',
      priority: 0.8,
    },
    {
      url: `${SITE_URL}/docs/customization`,
      lastModified: now,
      changeFrequency: 'monthly',
      priority: 0.7,
    },
    ...
    {
      url: `${SITE_URL}/docs/conversations`,
      lastModified: now,
      changeFrequency: 'monthly',
      priority: 0.7,
    },
    {
      url: `${SITE_URL}/docs/analytics`,
      lastModified: now,
      changeFrequency: 'monthly',
      priority: 0.7,
    },
